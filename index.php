...
{
  $teacher="select * from teacher order by date_created";
  $sql3=$pdo->prepare($teacher);
  $sql3->execute();
  $row3=$sql3->rowCount();
}
...
<head>
  ...
  <title><?= isset($row5['short_name'])?$row5['short_name']:""; ?>  <?= isset($query[0])?" | " . $query[0]:""; ?></title>
  <?php
  if(!isset($query[0]))
  {
    ?>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="search.html" class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Find Teacher<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
  ...
  <script>
    ...
    $(document).ready(function() {
      $('.Success').click(function() {
        toastr.success('New Added Successfully.')
      });
